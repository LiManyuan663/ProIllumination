...
class Options():
    ...
    def init(self, parser):        
        ...
        # args for saving 
        parser.add_argument('--save_dir', type=str, default ='ckpt',  help='save dir')
        ...
        parser.add_argument('--train_dir', type=str, default ='../DataSet/ISTD_Dataset+/',  help='dir of train data')
