import argparse
import os
from illumination.utils import util
...
class BaseOptions():
    ...
    def initialize(self):
        ...
        # help='if True, the datasets are loaded from "dataset" and "train" directories and the data pairs are aligned')
    ...
    def parse(self, print_info=False):
        ...
        self.opt.isTrain = self.isTrain  # train or dataset
